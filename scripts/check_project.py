...
REQUIRED = [
    ...
    "docs/schematic-layout.md",
    "docs/schematic-layout.json",
    "docs/test-plan.md",
    "docs/LESSONS.md",
...
PORTABILITY_FILES = [
    ...
    "tools/pcb_design/check_dependency_policy.py",
    "tools/pcb_design/check_schematic_layout_plan.py",
    "tools/pcb_design/check_schematic_layout_manifest.py",
